...
{
    /// <summary>
    /// A progress bar that can display custom text instead of a percentage.
    /// </summary>
    public class CustomTextProgressBar : ProgressBar
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Font f = new Font(FontFamily.GenericSerif, 10))
            {
                ...
                Point location = new Point(Convert.ToInt32(Width / 2 - len.Width / 2), Convert.ToInt32(Height / 2 - len.Height / 2 + 1));
